...
public class AgedColumnsFeature extends Feature<ColumnFeatureConfiguration> {
    ...
    public AgedColumnsFeature(Codec<ColumnFeatureConfiguration> p_65153_) {
        super(p_65153_);
    }
            ...
            if (blockpos1 != null) {
                ...
                for (BlockPos.MutableBlockPos blockpos$mutableblockpos = blockpos1.mutable(); j >= 0; j--) {
                    if (isAirOrLavaOcean(p_65168_, p_65169_, blockpos$mutableblockpos)) {
                        this.setBlock(p_65168_, blockpos$mutableblockpos, RocketBlocks.LUNAR_AGED_BASALT.getDefaultState());
                        blockpos$mutableblockpos.move(Direction.UP);
                        flag = true;
                    } else {
                        if (!p_65168_.getBlockState(blockpos$mutableblockpos).is(RocketBlocks.LUNAR_AGED_BASALT)) {
                            break;
                        }
